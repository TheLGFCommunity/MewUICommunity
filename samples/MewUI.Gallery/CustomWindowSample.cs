...
internal class CustomWindowSample : CustomWindow
{
    public CustomWindowSample()
    {
                    ...
                    new Border()
                        ...
                        .Child(new StackPanel()
                            ...
                            .Children(
                                ...
                                new TextBlock().Ref(out stateLabel)
                            )),
        ...
        void UpdateStateLabel() =>
            stateLabel.Text = $"WindowState: {WindowState} | IsActive: {IsActive} | Size: {ClientSize.Width:0}x{ClientSize.Height:0}";

        WindowStateChanged += _ => UpdateStateLabel();
        ClientSizeChanged += _ => UpdateStateLabel();
        Activated += UpdateStateLabel;
        Deactivated += UpdateStateLabel;
        ...
        var lightIcon = PathGeometry.Parse(
        ...
        var darkIcon = PathGeometry.Parse(
        ...
        {
            Data = Application.Current.Theme.IsDark ? lightIcon : darkIcon,
        ...
        themeIcon.WithTheme((t, s) => s.Fill(t.Palette.WindowText));
        ...
        themeBtn.Click += () =>
        {
            ...
            themeIcon.Data = isDark ? darkIcon : lightIcon;
        };
        TitleBarRight.Add(themeBtn);

        this.Resizable(600, 400, minWidth: 400, minHeight: 250).StartCenterOwner();
    }
